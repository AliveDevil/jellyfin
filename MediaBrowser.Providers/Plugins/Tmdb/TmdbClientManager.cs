...
namespace MediaBrowser.Providers.Plugins.Tmdb
{
    ...
    public class TmdbClientManager : IDisposable
    {
        ...
        /// </summary>
        /// <param name="episodeGroup">The Tmdb episode group.</param>
        ...
        public async Task<TvGroup?> GetSeriesGroupAsync(string episodeGroup, int seasonNumber, string? language, CancellationToken cancellationToken = default)
        {
            var key = $"group-{episodeGroup}-{seasonNumber.ToString(CultureInfo.InvariantCulture)}-{language}";
        ...
        /// <param name="episodeGroup">The episode group.</param>
        /// <param name="language">The episode's language.</param>
        /// <param name="imageLanguages">A comma-separated list of image languages.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The TMDb tv episode information or null if not found.</returns>
        public async Task<TvEpisode?> GetEpisodeAsync(int tvShowId, int seasonNumber, int episodeNumber, string? episodeGroup, string? language, string? imageLanguages, CancellationToken cancellationToken = default)
        {
            ...
            {
                var group = await GetSeriesGroupAsync(episodeGroup, seasonNumber, language, cancellationToken).ConfigureAwait(false);
